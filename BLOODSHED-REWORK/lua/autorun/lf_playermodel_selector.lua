...
convars["sv_playermodel_selector_gamemodes"]	= 0
...
net.Receive("lf_playermodel_cvar_change", function( len, ply )
	if ply:IsValid() and ply:IsPlayer() then
		...
		if !ply:IsAdmin() or !ply:IsUserGroup("donator") or ply:IsUserGroup("bigdonator") then return end
...
net.Receive("lf_playermodel_blacklist", function( len, ply )
	if ply:IsValid() and ply:IsPlayer() and (ply:IsAdmin() or ply:IsUserGroup("donator") or ply:IsUserGroup("bigdonator")) then
...
net.Receive("lf_playermodel_voxlist", function( len, ply )
	if TFAVOX_Models and ply:IsValid() and ply:IsPlayer() and (ply:IsAdmin() or ply:IsUserGroup("donator") or ply:IsUserGroup("bigdonator") or ply:IsUserGroup("bigdonator")) then
...
local function Allowed( ply )
	if GAMEMODE_NAME == "sandbox" or ( !Blacklist[GAMEMODE_NAME] and ( ply:IsAdmin() or ply:IsUserGroup("donator") or ply:IsUserGroup("bigdonator") or ply:IsUserGroup("bigdonator") or GetConVar( "sv_playermodel_selector_gamemodes"):GetBool() ) ) then
...
net.Receive("lf_playermodel_update", function( len, ply )
	if ply:IsValid() and ply:IsPlayer() and ( ply:IsAdmin() or ply:IsUserGroup("donator") or ply:IsUserGroup("bigdonator") or GetConVar( "sv_playermodel_selector_instantly"):GetBool() ) then
		if game.SinglePlayer() or ply:IsAdmin() or ply:IsUserGroup("donator") or ply:IsUserGroup("bigdonator") then
...
local function LoadPlayerModel()
	if LocalPlayer():IsAdmin() or LocalPlayer():IsUserGroup("donator") or LocalPlayer():IsUserGroup("bigdonator") or GetConVar( "sv_playermodel_selector_instantly" ):GetBool() then
...
function Menu.Setup()
	...
	Menu.ApplyButton:SetEnabled( LocalPlayer():IsAdmin() or LocalPlayer():IsUserGroup("donator") or LocalPlayer():IsUserGroup("bigdonator") or GetConVar( "sv_playermodel_selector_instantly" ):GetBool() )
...
--------------------------------------------------------
		...
		Menu.Right:AddSheet( "Settings", moretab, "icon16/key.png" )
			...
			if LocalPlayer():IsAdmin() or LocalPlayer():IsUserGroup("donator") or LocalPlayer():IsUserGroup("bigdonator") then
...
function Menu.Toggle()
	if LocalPlayer():IsAdmin() or LocalPlayer():IsUserGroup("donator") or LocalPlayer():IsUserGroup("bigdonator") or GAMEMODE_NAME == "sandbox" or GetConVar( "sv_playermodel_selector_gamemodes" ):GetBool()
	then
